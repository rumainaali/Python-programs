'''  Date:25/03/2024
You have a list of student names. you have one list each for their marks in CS, Math 
and English.hard code the values. no need to get it as input
Pass mark is 50.
...
stu_list=['Sheela','Rumaina','Rakhi','Keerthana','Sharon']
